...
## 1° Validación de escala de echo chambers

### ventajas:

1. Fácil y rápida
2. francisco Conoce del tema en términos teóricos


### Desventajas

1. Da para un paper sólo eso, considerando que ya se hizo uno?
2. Esto e smuestra nacional y representativa
3. Habría que agregarle un caso de aplicación

---
## lista de variables que nos interesa explorar para refinar:
